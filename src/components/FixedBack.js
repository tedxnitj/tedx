  ...
  return (
    <div className='fixedBack'>
      ...
      <div className='heading__mobile'>
        ...
        <h1>REVERBERA<span className="makeitred">TED</span></h1></Fade>
...
<div className='heading__mobile2'>
        <Fade direction='up' triggerOnce>
        <h1 ><span className="makeitred">15 </span>April 2023</h1></Fade>
        <h1 ><span className="makeitred">12 PM - </span>6 PM</h1>
      </div>
      ...
      <div className="Timer">
                ...
                <div className='buttonsintimer'>
                <button className="vvd redback" onClick={handleShow2} data-toggle="modal"><span>DON'T MISS</span></button>
